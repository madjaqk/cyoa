...
```
_Around here, I change the interface for this incredibly talky section.  I would provide a list of things to possibly ask about (more or less anything that's come up in the text, plus people were encouraged to ask about anything else I didn't think of) as well as other people they could try talking to.  For example:_
```
UNLOCKED KEYWORDS:
...
When you're 20 minutes away you enter radio range of the station.  Vinnie signals your approach:  "Breaker, this is Vinnie and Ethanicus, Federated Space registration number
6-4-8-3-5-5, here to drop off your musical guests, do you copy?"  There's no answer.
...
```
_[E] Wait for someone to show up_
```
